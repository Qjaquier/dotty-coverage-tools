...
class ScoverageHtmlWriter(sourceDirectories: Seq[File], outputDir: File, sourceEncoding: Option[String]) extends BaseReportWriter(sourceDirectories, outputDir) {
  ...
  def write(coverage: Coverage): Unit = {
    ...
    val index = "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"/><title id='title'>Scoverage Code Coverage</title><link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/pure/0.3.0/pure-min.css\"></head><frameset cols=\"25%,*\"><frame src=\"packages.html\" name=\"packagesFrame\"><frame src=\"overview.html\" name=\"mainFrame\"></frameset></html>"
//IOUtils.readStreamAsString(getClass.getResourceAsStream("/scoverage/index.html"))
